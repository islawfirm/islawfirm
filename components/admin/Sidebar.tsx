...
export default function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-[#8B0000] to-[#9B0000] shadow-2xl z-40">
      {/* Logo */}
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-white font-serif font-bold text-lg">I.S. Law Firm</h2>
